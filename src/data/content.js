...
export const integrationCategories = [
  ...
  },
  {
    ...
    connectors: [
      { name: "Confluence Cloud",       slug: "confluence-cloud",       status: "confirm" },
      { name: "Confluence Data Center", slug: "confluence-data-center", status: "confirm" },
      { name: "Knowledge Owl",          slug: "knowledge-owl",          status: "confirm" },
      { name: "MindTouch",              slug: "mindtouch",              status: "confirm" },
      { name: "SharePoint",             slug: "sharepoint",             status: "confirm" },
    ],
  },
  {
    ...
    connectors: [
      { name: "Slack",            slug: "slack",            status: "confirm" },
